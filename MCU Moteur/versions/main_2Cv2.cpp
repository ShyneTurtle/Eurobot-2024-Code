...
#define PWM_WRAP_VALUE  5000     // Précision du pwm (1 -> 0xffff), influe aussi sur la fréquence du pwm
...
int main()  {
  ...
  motor1.consigne = PWM_WRAP_VALUE * 0.25;
...
void core1()  {
  ...
  motor2.consigne = PWM_WRAP_VALUE * 0.5;
